...
export const Projects = () => {
  const reactProjects = [
    ...
    {
      title: "Zap QR",
      description: "A modern QR code generator application built with React.js, allowing users to create and customize QR codes easily.",
      tech: ["React", "QR API", "Tailwind CSS"],
      liveUrl: "https://qr-app-zeta.vercel.app/",
      githubUrl: "https://github.com/MDharunPrasad/qr-app",
      featured: true
    }
  ];
  ...
  const figmaProjects = [
    ...
    {
      title: "Netflix Vision Pro",
      description: "A visionary redesign of Netflix for Apple Vision Pro, exploring next-generation user interactions and immersive experiences.",
      tech: ["Figma", "UI/UX", "Vision Pro", "Interactive Design"],
      liveUrl: "https://www.figma.com/design/m9O9RUY7Y6HmO4mRbsm3Nd/Personal?node-id=0-1&t=BuWqU63zvLmxlyUg-1",
      githubUrl: "#",
      featured: true
    },
    {
      title: "Donut Delight",
      description: "A delightful and mouth-watering UI design for a donut shop, featuring playful animations and appetizing visuals.",
      tech: ["Figma", "UI/UX", "Animation", "Food & Beverage"],
      liveUrl: "https://www.figma.com/design/m9O9RUY7Y6HmO4mRbsm3Nd/Personal?node-id=3-1452&t=BuWqU63zvLmxlyUg-1",
      githubUrl: "#",
      featured: true
    }
  ];
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-purple-950 via-indigo-950 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-white mb-8 font-rajdhani">
...
const ProjectCard = ({ project, index }: { project: any; index: number }) => (
  <div className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/20 hover:border-cyan-400/50 transition-all duration-500 hover:scale-105 shadow-xl hover:shadow-cyan-500/20">
